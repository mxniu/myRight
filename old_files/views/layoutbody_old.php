...
<?php for ($i = 7; $i < 20; $i++):
	...
	<div class="list-element" <?php if($i === 7) echo 'style="border-top: none;"'; ?>>
		<div class="title-wrapper"><a class="title" href="../<?=$method?>/<?php echo $element->slug?>" id="<?=$element->slug?>" data-toggle="modal"><?=$element->title?><div class="list_source"><?php echo preg_replace("/^www\./", "", parse_url($element->url, PHP_URL_HOST));?></div></a></div>
