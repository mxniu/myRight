...
-- Generation Time: Jul 31, 2012 at 04:55 PM
...
CREATE TABLE `links` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=311 ;
...
(3, 'primary', 'http://www.law.cornell.edu/uscode/text/1/7', 1, 'Section 3 of DOMA defines marriage as the legal union between one man and one women. ', 'What the Federal Government Defines as Marriage', 87, 'same-sex marriage, doma, federal law, section 3, marriage defintion', 'what-the-federal-government-defines-as-marriage', '', 0, 0, ''),
...
(37, 'photo', 'http://healthreform.kff.org/~/media/Images/KHS/Flowcharts/requirement_flowchart_2.gif?w=800&h=1041&as=1', 1, 'The individual mandate is a provision part of the Affordable Care Act, also know as Obamacare. It requires most people to have health insurance coverage or face a penalty. The conditions are briefly outlined in this flowchart. ', 'Individual Mandate', 67, 'healthcare reform, individual mandate, obamacare', 'individual-mandate', '', 0, 0, ''),
...
(140, 'photo', 'http://3.bp.blogspot.com/_N_aDa0MnjQE/S9jnIqCWQwI/AAAAAAAAAGI/Z7wZ_LLlB2c/s1600/transparency-1.jpg', 1, 'In 2010, Obama signed into law the Patient Protection and Affordable Care Act, also known as Obamacare. The law is meant to provide incentives for people to secure health benefits. One controversial section of the bill is the individual mandate, which imposes a penalty on persons who do not purchase health insurance. However, the Supreme Court has ruled that the mandate is constitutional under Congress''s designated taxing power. ', 'Healthcare Reform', 99, 'healthcare reform, obamacare', 'healthcare-reform', '', 0, 0, ''),
(142, 'photo', 'http://images.onlineuniversity.net.s3.amazonaws.com/new-student-loan-deal.jpg', 1, 'In 2010, Obama signed into law the Health Care and Education Reconciliation Act of 2010, which included a number of loan reforms for students. Its provisions include: an increase in Pell Grant awards, loan forgiveness after 20 years (previously 25), a cap on repayments at 10% (previously 15%), and increasing funding.', 'Education Reform', 73, 'education, student loans', 'education-reform', '', 0, 0, ''),
(143, 'photo', 'http://sociable.co/wp-content/uploads/2011/12/SOPA-business-infographic-488x2761.png', 1, 'The Stop Online Piracy Act (SOPA) is a bill that expands the rights of law enforcement to fight illegal sharing of copyrighted materials. ', 'SOPA', 88, 'sopa, business, innovation', 'sopa', '', 0, 0, ''),
(292, 'news', 'http://www.buzzfeed.com/chrisgeidner/federal-trial-court-in-connecticut-strikes-down-do', 1, 'U.S. District Court Judge Vanessa L. Bryant today held in a federal case in Connecticut that Section 3 of the Defense of Marriage Act - the federal definition of marriage - is unconstitutional. Bryant, in a case brought by Gay & Lesbian Advocates & Defenders, follows several other federal judges over the past two years to have reached the same conclusion.', 'Federal Trial Court In Connecticut Strikes Down DOMA''s Marriage Definition', 97, 'doma, unconstitutional', 'federal-trial-court-in-connecticut-strikes-down-domas-marriage-definition', '', 0, 0, ''),
...
(242, 'primary', 'https://pci.etimspayments.com/pbw/include/la/input.jsp', 3, 'Drivers are able to pay for their parking tickets online. The ticket number and driver''s information are required. Click to be redirected to the website where you can pay.', 'Pay your Parking Ticket Here', 20, 'parking, fines, pay', 'pay-your-parking-ticket-here', '', 0, 0, 'Los Angeles'),
...
(246, 'primary', 'https://pci.etimspayments.com/pbw/include/la/complaintform.jsp?complainttype=6', 3, 'Traffic violators are allowed to request a hearing to contest a parking citation. There is an online form that individuals are able to use. Be sure to have the citation issue date, violation number, and other relevant personal information ready. ', 'Fight Your Ticket Online', 92, 'parking, appeal', 'fight-your-ticket-online', '', 0, 0, 'Los Angeles'),
...
(257, 'primary', 'https://www.pticket.com/scripts/Autobahn.exe/Execute?Application=pTicket&Program=REPORT-query_citation&parmAGENCY_STATE=CA&parmAGENCY_LOC=SANJOSE&DSI=0', 3, 'San Jose drivers are able to pay for their parking tickets online. Be sure to have your citation number, driver''s license, and credit or debit card number available. Click to be directed to the online pay form.', 'Pay your Parking Ticket Here', 25, 'parking, fines, pay', 'pay-your-parking-ticket-here', '', 0, 0, 'San Jose'),
(258, 'primary', 'https://wmq.etimspayments.com/pbw/include/sanfrancisco/main.jsp', 3, 'San Francisco parking citations can be paid online. Individuals will need either a debit or credit card. There is a $2.50 service charge to use this system. Vehicles that have been towed or booted are ineligible for this system and must directly pay at the SFMTA Customer Service Center.', 'Pay your Parking Ticket Here', 24, 'parking, fines, pay', 'pay-your-parking-ticket-here', '', 0, 0, 'San Francisco'),
...
(303, 'secondary', 'https://www.eff.org/issues/dmca/', 1, 'The Digital Millennium Copyright Act (DMCA) has two controversial sections, which are the "anti-circumvention" and "safe harbor" provisions. The "anti-circumvention" provisions are intended to stop copyright pirates from defeating Digital Rights Management (DRM). It is controversial because it may affect non-infringing fair use. The "safe harbor" provisions protects service providers from monetary liability based on the allegedly infringing activities of third parties. Although copyright holders may not like the "safe harbor" provision, it is important for innovators and free expression online.', 'What is DMCA?', 59, 'dmca, copyright, safe harbor', 'what-is-dmca', '', 0, 0, ''),
(304, 'secondary', 'http://www.cnn.com/2012/03/22/tech/web/isps-sopa-piracy/index.html?iref=allsearch', 1, '(CNN) -- SOPA appears to be dead. But the battle over Internet piracy is not. In the wake of the debate over theStop Online Piracy Act, supporters of that now-abandoned bill are looking to Internet service providers for help; they''re also taking other tacks that Web-freedom advocates say could have much the same effect as SOPA would have had.', 'With SOPA shelved, anti-piracy advocates take new approaches - CNN.com', 47, 'sopa, anti-piracy, censorship, acta', 'with-sopa-shelved-anti-piracy-advocates-take-new-approaches-cnncom', '', 0, 0, ''),
