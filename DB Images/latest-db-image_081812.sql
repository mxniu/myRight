...
-- Generation Time: Aug 18, 2012 at 12:46 PM
...
(41, 'secondary', 'http://www.kff.org/healthreform/upload/8023-R.pdf', 1, 'The Affordable Care Act (2010), also known as Obamacare, contains many provisions on healthcare reform including: an individual mandate requiring most individuals to have health insurance, employer requirements, new regulations to private insurance providers, an expansion of Medicaid, and Health Benefit Exchanges. ', 'Obamacare Basics', 93, 'healthcare reform, affordable care act, obamacare, medicaid', 'obamacare-basics', '', 0, 0, '', 16),
...
(209, 'primary', 'http://supreme.justia.com/cases/federal/us/251/385/case.html', 4, 'In Silverthorne Lumber Co., Inc. v. United States (1920), the Supreme Court Ruled that illegal seized evidence and it''s derivatives were not admissible in court. ', 'Fruit of the Poisonous Tree Case', 7, 'evidence, constitution, police misconduct', 'fruit-of-the-poisonous-tree-case', '', 0, 0, '', 1),
...
CREATE TABLE `views` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=948 ;
