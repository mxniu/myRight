...
-- Generation Time: Aug 17, 2012 at 12:47 PM
...
CREATE TABLE `questions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=1881 ;
...
(24, 4, 'EX', 'Jail &ndash; 4 days to 6 months<br/>Fines &ndash; $1800 to $2800<br/>License Suspension &ndash; 30 days to 10 months', 'First', 5, 'Continue,,', '', 0),
(25, 4, 'IN', 'When did you get arrested? Enter date:', '', 9, 'Enter date:,,dmv', '', 0),
(26, 4, 'EX', 'You have a right to fight your license suspension. To do this you must request a DMV hearing within 10 days of your arrest. A DUI attorney will file this request for you and represent you in the process. ', '', 10, 'Continue,,', '', 0),
...
(105, 4, 'EX', 'Jail &ndash; 10 days to 1 year<br/>Fines &ndash; $1800 to $2800<br/>License Suspension &ndash; 2 years', 'Second', 6, 'Continue,,', '', 0),
(106, 4, 'MB', 'Jail &ndash; 120 days to 1 year<br/>Fines &ndash; $1800 to $18000<br/>License Suspension &ndash; 3 years', 'Third', 7, 'Continue,,', '', 0),
(107, 4, 'EX', 'If you have had 3 or more separate DUI convictions in the past 10 years&#44; this offense will most likely be charged as a felony.<br/>Jail &ndash; up to 3 years<br/>Fines &ndash; $390 to $1000<br/>License Suspension &ndash; 4 years', 'More', 8, 'Continue,,', '', 0),
...
(1880, 4, 'EX', 'Did you just get a DUI? Find out possible penalties and rights you have! ', '', 1, 'Start Guide,,', '', 0);
...
CREATE TABLE `track_entries` (
  ...
  `timestamp` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=1052 ;
...
CREATE TABLE `views` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=884 ;
