...
-- Generation Time: Aug 12, 2012 at 04:39 PM
...
(4, 'primary', 'http://www.law.cornell.edu/uscode/text/28/1738C', 1, 'Section 2 of DOMA states that States are not required to recognize another States'' same-sex marriage laws.', 'Section 2 of DOMA', 44, 'same-sex marriage, doma, federal law, section 2, supremacy clause', 'section-2-of-doma', '', 0, 0, '', 0),
...
(44, 'primary', 'http://www.supremecourt.gov/opinions/11pdf/11-393c3a2.pdf', 1, 'National Federation of Independent Business v. Sebelius (2012). Supreme Court rules that individual mandate is constitutional under the taxation clause of the US Constitution', 'Individual Mandate is Constitutional!', 40, 'healthcare reform, supreme court, individual mandate, taxing power', 'individual-mandate-is-constitutional', '', 0, 0, '', 1),
...
(41, 'secondary', 'http://www.kff.org/healthreform/upload/8023-R.pdf', 1, 'The Affordable Care Act (2010), also known as Obamacare, contains many provisions on healthcare reform including: an individual mandate requiring most individuals to have health insurance, employer requirements, new regulations to private insurance providers, an expansion of Medicaid, and Health Benefit Exchanges. ', 'Obamacare Basics', 92, 'healthcare reform, affordable care act, obamacare, medicaid', 'obamacare-basics', '', 0, 0, '', 12),
...
(76, 'secondary', 'http://www.irs.gov/businesses/small/article/0,,id=98277,00.html', 2, 'An LLC is a business structure allowed by state statute. However, the federal government does not recognize it as a separate classification for federal tax purposes. An LLC business entity must file a corporation, partnership or sole proprietorship tax return.', 'LLCs and IRS Classification', 32, 'llc, tax, entity', 'llcs-and-irs-classification', '', 0, 0, '', 0),
(77, 'secondary', 'http://www.nolo.com/legal-encyclopedia/key-advantages-llc.html', 2, 'LLCs have flexibility, limited liability, pass-through taxation, and less administrative paperwork.  Most states allow single member or multiple member LLCs that can create their own operating agreements. Like most legal entities, LLCs protect members from liability, which prevents creditors of the company from pursuing personal assets of any member. Further, a LCC avoids double taxation because all income is passed through to the members and then taxed. ', 'Key Advantages of an LLC', 94, 'llc, tax, management, entity', 'key-advantages-of-an-llc', '', 0, 0, '', 9),
(78, 'secondary', 'http://mashable.com/2010/08/02/legal-structure-startup/', 2, 'Information on LLC, S-Corporation, and C-Corporation.', 'HOW TO: Legally Structure your Startup', 74, 'llc, corporation, s-corporation, entity', 'how-to-legally-structure-your-startup', '', 0, 0, '', 3),
...
(97, 'secondary', 'http://www.trademarkia.com/', 2, 'A trademark is a distinctive sign or indicator that is used to help consumers identify and distinguish products or services of a specific business. A trademark is usually a word, phrase, name, symbol, logo, design, image or combination of the above. Use trademarkia to preform a free search to see if a trademark is available.', 'Free Trademark Search Online', 94, 'ip, trademark, name search', 'free-trademark-search-online', '', 0, 0, '', 10),
...
(129, 'secondary', 'http://www.youtube.com/watch?v=MXnqhG2h9QA', 1, 'Around 20% of illegal immigrants are under the age of 18. The DREAM Act seeks to provide young immigrants U.S. residency to those that 1. entered the country before the age of 16; 2. have an American high school diploma or GED; 3. are 35 years or younger; 4. have no criminal record. Those that are eligible are allowed to complete a 2-year degree or serve for 2 years in the military. This program will result in an annual fiscal contribution of $9,200 per person.  ', 'A Dream Act Infographic', 60, 'immigration, dream act', 'a-dream-act-infographic', '', 0, 0, '', 1),
...
(223, 'secondary', 'http://www.shouselaw.com/gerd.html', 4, 'Medical conditions that will lead to an inaccurate BAC result on a breathlyzer: GERD, Acid Reflux, and Heartburn.', 'GERD, Acid Reflex, and Heartburn Mess Up Breathalyzer', 46, 'breath test', 'gerd-acid-reflex-and-heartburn-mess-up-breathalyzer', '', 0, 0, '', 0),
...
(227, 'secondary', 'http://www.dmv.ca.gov/pubs/vctop/d11_5/vc23578.htm', 4, 'A BAC of 0.15% or greater may result in increased penalties.', 'Was your BAC 0.15% or Higher?', 84, 'penalties, bac', 'was-your-bac-015-or-higher', '', 0, 0, 'California', 0),
...
(238, 'news', 'http://www.huffingtonpost.com/2012/07/03/la-parking-ticket-increase_n_1648024.html', 3, 'The Los Angeles City Council has approved a $5 increase on parking tickets Tuesday. The fee hike is LA''s sixth parking ticket increase in seven years. Officials hope the increased revenue will make a dent in the city''s $238 million budget deficit. Here are the ticket fines for some of the most common parking violations.', 'Parking Ticket Fines Are Going Up AGAIN', 91, 'parking, fines', 'parking-ticket-fines-are-going-up-again', '', 0, 0, 'Los Angeles', 5),
...
(241, 'primary', 'http://www.amlegal.com/nxt/gateway.dll?f=templates&fn=default.htm&vid=amlegal:lamc_ca', 3, 'The city of Los Angeles has a separate municipal code for drivers to follow. Click "view source" to check Chapter VIII of the Municipal Code for the Traffic Code.', 'The Traffic Code: Los Angeles', 53, 'parking, traffic', 'the-traffic-code-los-angeles', '', 0, 0, 'Los Angeles', 0),
...
(271, 'primary', 'http://www.nyc.gov/html/dot/html/motorist/prkintro.shtml#regs', 3, 'If a T-intersection does not have any traffic signals, all-way stop signs or crosswalk markings, then it''s alright to park on the edges of the intersection. A curb cut is the part of a sidewalk that has been lowered or cut so that pedestrians have an easier time walking across the street.', 'General Parking Information', 67, 'parking', 'general-parking-information', '', 0, 0, 'New York City', 1),
...
(23, 4, 'MB', 'Is this your Frist, Second, or Third DUI?', '', 1, 'First,,|Second,,|Third,,|More,,', ''),
(24, 4, 'MB', 'Show DUI chart', '', 2, 'Continue,,', ''),
(25, 4, 'MB', 'When did you get arrested?', '', 3, 'Enter date:,,', ''),
(26, 4, 'MB', 'You have a right to fight your license suspension. To do this you must request a DMV hearing within 10 days of your arrest. A DUI attorney will file this request for you and represent you in the process. ', '', 4, 'Continue,,', ''),
(27, 4, 'MB', 'After you were arrested, did you take a breath, blood, or urine test?', '', 5, 'Yes,Chemical,|No, refused,Refusal,|No, not given,,', ''),
(28, 4, 'MB', 'Which one of the following tests did you take?', 'Chemical', 6, 'Breath,Breath,|Blood,,|Both,Breath,', ''),
(29, 4, 'MB', 'Did you burp, vomit, smoke, regurgitate, drink, smoke, or eat 15 minutes before the breathalyzer?', 'Breath', 7, 'Yes,Inaccurate,|No,,', ''),
(30, 4, 'MB', 'Your BAC results may be inaccurate. When you burp, vomit, regurgitate, drink, smoke, or eat, a tiny amount of alcohol was probably introduced to your mouth. Since the breathalyzer machine assumes that it is only measuring your breath alcohol, a tiny amount of mouth alcohol may have produced an inaccurate BAC measurement. Other conditions that may increase your mouth alcohol or register an inaccurate measurement include dentures, diabetes, and the use of alcohol-containing products such as mouthwash, breath spray, and cough syrup.', 'Inaccurate', 8, 'Continue,,', ''),
(31, 4, 'MC', 'What was your BAC?', 'Chemical', 9, 'Less than 0.15%,Rising,|0.15% or greater,High BAC,', ''),
(32, 4, 'MC', 'Did you drink shortly before getting arrested?', 'Rising', 10, 'Yes,Rising2,|No,,', ''),
(33, 4, 'MC', 'You may have a "Rising BAC Defense." What matters in a DUI case is your BAC at the time of driving, not your BAC at the police station. To figure this out, prosecutors will try to estimate your driving BAC. Most of the time they will estimate a BAC higher than the test results because they assume that your body was burning off alcohol between the time of arrest and testing. However, this assumption is false if you had a drink shortly before being arrested and/or tested, because your body was still absorbing that drink. This is called the "Rising BAC defense" and it might be used to help your case. ', 'Rising2', 11, 'Continue,,', ''),
(34, 4, 'MC', 'A BAC of 0.15% or greater is an aggravating factor and may result in increased penalties.', 'High BAC', 12, 'Continue,,', ''),
(35, 4, 'MC', '[possible chart?] Automatic penalties may be imposed for refusing a chemical test, such as a 1 year license suspension for the first conviction. This is because implied consent laws demand that you submit to testing or face the consequences.', 'Refusal', 13, 'Continue,,', ''),
(36, 4, 'MC', 'How were you pulled over?', '', 14, 'Traffic Stop,Traffic,|DUI Checkpoint,Checkpoint,|Accident,Accident,', ''),
(37, 4, 'MC', 'Police must have probable cause before pulling over a car. An officer has probable when there is a reasonable, articulable suspicion that a law has been broken. In most instances, breaking a traffic law will give rise to probable cause.', 'Traffic', 15, 'Continue,,', ''),
(38, 4, 'MC', 'Were you going over the speed limit?', 'Traffic', 16, 'No,,|1 to 19 mph over the limit,,|20 to 29 mph over the limit,Freeway,|30 mph over the limit,Speeding,', ''),
(39, 4, 'MC', 'Were you driving on a freeway?', 'Freeway', 17, 'Yes,,|No,Speeding,', ''),
(40, 4, 'MC', 'Driving recklessly over the speed limit may trigger an additional 60 day jail sentence. Reckless driving is driving that will probably injure someone and you are aware of that risk. The enhancement may apply if you were driving 30 mph over the speed limit on a freeway or 20 mph over the speed limit on any other road.', 'Speeding', 18, 'Continue,,', ''),
(41, 4, 'MC', 'DUI checkpoints are governed by strict rules and regulations.', 'Checkpoint', 19, 'Continue,,', ''),
(42, 4, 'MC', 'Was anyone injured?', 'Accident', 20, 'Yes,Wobbler,|No,,', ''),
(43, 4, 'MC', 'A DUI with injury is a wobbler, which the prosecutor can charge it as a felony or misdemeanor. Felonies typically carry harsher penalties than misdemeanors, including possible jail time and large fines.', 'Wobbler', 21, 'Continue,,', ''),
(44, 4, 'MC', 'Was there a passenger under the age of 14 in the car?', '', 22, 'Yes,Minor,|No,,', ''),
(45, 4, 'MC', 'Driving with a passenger under the age of 14 is a serious issue and a 48 hour jail sentence may be imposed, regardless of whether or not probation is granted. Prosecutors may choose to file child endangerment charges as well', 'Minor', 23, 'Continue,,', '');
...
CREATE TABLE `views` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=595 ;
