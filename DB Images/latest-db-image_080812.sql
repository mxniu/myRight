...
-- Generation Time: Aug 08, 2012 at 12:31 PM
...
(41, 'secondary', 'http://www.kff.org/healthreform/upload/8023-R.pdf', 1, 'The Affordable Care Act (2010), also known as Obamacare, contains many provisions on healthcare reform including: an individual mandate requiring most individuals to have health insurance, employer requirements, new regulations to private insurance providers, an expansion of Medicaid, and Health Benefit Exchanges. ', 'Obamacare Basics', 92, 'healthcare reform, affordable care act, obamacare, medicaid', 'obamacare-basics', '', 0, 0, '', 9),
...
(77, 'secondary', 'http://www.nolo.com/legal-encyclopedia/key-advantages-llc.html', 2, 'LLCs have flexibility, limited liability, pass-through taxation, and less administrative paperwork.  Most states allow single member or multiple member LLCs that can create their own operating agreements. Like most legal entities, LLCs protect members from liability, which prevents creditors of the company from pursuing personal assets of any member. Further, a LCC avoids double taxation because all income is passed through to the members and then taxed. ', 'Key Advantages of an LLC', 94, 'llc, tax, management, entity', 'key-advantages-of-an-llc', '', 0, 0, '', 5),
(78, 'secondary', 'http://mashable.com/2010/08/02/legal-structure-startup/', 2, 'Information on LLC, S-Corporation, and C-Corporation.', 'HOW TO: Legally Structure your Startup', 74, 'llc, corporation, s-corporation, entity', 'how-to-legally-structure-your-startup', '', 0, 0, '', 1),
...
(97, 'secondary', 'http://www.trademarkia.com/', 2, 'A trademark is a distinctive sign or indicator that is used to help consumers identify and distinguish products or services of a specific business. A trademark is usually a word, phrase, name, symbol, logo, design, image or combination of the above. Use trademarkia to preform a free search to see if a trademark is available.', 'Free Trademark Search Online', 94, 'ip, trademark, name search', 'free-trademark-search-online', '', 0, 0, '', 4),
...
(99, 'primary', 'http://www.thomasfirm.com/trademarks.html', 2, 'A trademark is a distinctive sign or indicator that is used to help consumers identify and distinguish products or services of a specific business or person. A trademark is usually a word, phrase, name, symbol, logo, design, image or combination of the above. The main purpose of a trademark is to identify a business as the source of specific goods or services. You are not required to register a trademark and can establish rights over that mark based on legitimate use. ', 'What is a Trademark?', 87, 'ip, patent, trademark, name search', 'what-is-a-trademark', '', 0, 0, '', 3),
...
(238, 'news', 'http://www.huffingtonpost.com/2012/07/03/la-parking-ticket-increase_n_1648024.html', 3, 'The Los Angeles City Council has approved a $5 increase on parking tickets Tuesday. The fee hike is LA''s sixth parking ticket increase in seven years. Officials hope the increased revenue will make a dent in the city''s $238 million budget deficit. Here are the ticket fines for some of the most common parking violations.', 'Parking Ticket Fines Are Going Up AGAIN', 91, 'parking, fines', 'parking-ticket-fines-are-going-up-again', '', 0, 0, 'Los Angeles', 4),
...
(272, 'secondary', 'http://parkitnyc.com/parking-nyc/nyc-parking-tickets/no-standing-ticket-nyc/', 3, 'No Parking means you can drop off and pick up people and personal property. No Standing means you can drop off and pick up people only. No Stopping means you can''t stop at all.', 'The Difference Between No Parking, No Standing, and No Stopping Signs', 89, 'parking, signs', 'the-difference-between-no-parking-no-standing-and-no-stopping-signs', '', 0, 0, 'New York City', 1),
...
(283, 'primary', 'http://www.nyc.gov/html/dof/html/parking/park_tickets_appeal.shtml', 3, 'To request an appeal, file an Appeal Application within 30 days of the Administrative Law Judge''s hearing decision. Both these applications are available online via the "view source" button.', 'Appeal a Hearing Desicsion', 81, 'parking, appeal', 'appeal-a-hearing-desicsion', '', 0, 0, 'New York City', 2),
...
(329, 'document', 'http://www.ycombinator.com/seriesaa/aa-termsheet.doc', 2, 'This is YC''s Series AA Term sheet. ', 'YC Series AA Termsheet', 21, 'term sheet, document', 'yc-series-aa-termsheet', '', 0, 0, '', 0),
...
(334, 'document', 'http://www.docracy.com/263/founder-advisor-standard-template', 2, 'Example of an Advisor Agreement that can be tailored to fit your needs.', 'Advisor Agreement', 50, 'advisor, document', 'advisor-agreement', '', 0, 0, '', 3),
(335, 'secondary', 'http://smallbusiness.findlaw.com/incorporation-and-legal-structures/incorporating-in-delaware-is-it-worth-it-for-my-small.html', 2, 'Incorporating in Delaware might not make sense if you plan on keeping your business small. This is because you will still have to pay taxes within your home state, as well as Delaware. Additionally, your business may still have to qualify to do business in your home state.  This is an additional cost. In some instances, your small business may be more protected in your home state. Lastly, you might have to go to court in Delaware for any related legal issues, which can be costly and time consuming. ', 'Is Delaware Really Right for my Business?', 87, 'corporation, delaware, entity', 'is-delaware-really-right-for-my-business', '', 0, 0, '', 3),
...
CREATE TABLE `views` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=329 ;
