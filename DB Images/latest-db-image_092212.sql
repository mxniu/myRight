...
-- Generation Time: Sep 22, 2012 at 07:53 PM
...
(99, 'primary', 'http://www.thomasfirm.com/trademarks.html', 2, 'A trademark is a distinctive sign or indicator that is used to help consumers identify and distinguish products or services of a specific business or person. A trademark is usually a word, phrase, name, symbol, logo, design, image or combination of the above. The main purpose of a trademark is to identify a business as the source of specific goods or services. You are not required to register a trademark and can establish rights over that mark based on legitimate use. ', 'What is a Trademark?', 87, 'ip, patent, trademark, name search', 'what-is-a-trademark', '', 0, 0, '', 23),
...
(146, 'secondary', 'http://inventors.about.com/od/trademarks/a/register.htm', 2, 'You are not required to register a trademark and can establish rights over that mark based on legitimate use. However, the benefits of having a registered trademark include: constructive notice nationwide of the trademark owner''s claim, additional evidence of the ownership of the trademark, jurisdiction of federal courts may be invoked, and registration can be used as a basis for obtaining registration in other countries.', 'Why You Should Register a Trademark', 83, 'ip, trademark, register', 'why-you-should-register-a-trademark', '', 0, 0, '', 11),
...
CREATE TABLE `questions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=2368 ;
...
CREATE TABLE `track_entries` (
  ...
  `timestamp` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=4325 ;
...
CREATE TABLE `views` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=2999 ;
