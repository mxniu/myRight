	...
	$.fn.loadResults = function()
	{
		...
		for(x in fstack)
		{
			...
			{
				$('#report_window').append('<div style="height: 26px; font-family: \"Lato\", sans-serif; font-size: 1.1em; font-weight: 300;"><div style="width: 300px"><div class="radiobutton" style="margin-right: 5px; background-position: 0px ' + check_bg_pos + 'px"></div>' + fstack[x]['factor'] + '</div></div>');
			}
			else
			{
				var percentage = 0;
			...
			$('#report_window').append('<div style="height: 26px; font-family: \"Lato\", sans-serif; font-size: 1.1em; font-weight: 300;"><div style="width: 300px; float: left;"><div class="radiobutton" style="margin-right: 5px; background-position: 0px ' + check_bg_pos + 'px"></div>' + fstack[x]['factor'] + '</div><div style="float: right">' + percentage + '%</div></div>');
			}	
		}
