...
(function($) {
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				steps			: 40,											// steps taken to reach target
				stepDuration	: 20,											
				max				: 100,											// Upon 100% i'd assume, but configurable
				showText		: true,											// show text with percentage in next to the progressbar? - default : true
				textFormat		: 'percentage',									// Or otherwise, set to 'fraction'
				width			: 367,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green.gif'
				height			: 46,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: 'images/progressbarlarge.png',						// boxImage : image around the progress bar
				barImage		: {
									0:	'images/progressbg_greenlarge.png',
									30: 'images/progressbg_greenlarge.png',
									70: 'images/progressbg_greenlarge.png'
								},
