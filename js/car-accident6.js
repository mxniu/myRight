...
function scale(QUNIT, to_append, answer_array)
{
	...
	to_append += '<div class="left" style="position: relative; width: 150px; height: 300px; margin-left: 80px; display: block;"><div style="position: absolute; z-index: 0; top: 3px; left: 58px; background: url(/images/scale_base.png); width:104px;height:240px" id="scale_base"></div><div style="position: absolute; z-index: 10; top: 0px; left: 0px; background: url(/images/scale_arm.png); width:216px;height:48px;" id="scale_arm"></div><div style="position: absolute; z-index: 0; top: 30px; left: -40px; background: url(/images/scale_left.png); width:103px;height:108px" id="scale_left"></div><div style="position: absolute; z-index: 0; top: 30px; left: 155px; background: url(/images/scale_right.png); width:103px;height:108px" id="scale_right"></div></div><div class="right" style="width: 300px; margin-right: 50px"><div id="rs_caption" style="font-size: 1.5em; width: 100%; text-align: center;">50%</div>';
	to_append += '<div style="position: relative"><div style="position: absolute; top: 23px; left: 53px;">0%</div><div style="position: absolute; top: 23px; left: 135px;">50%</div><div style="position: absolute; top: 23px; left: 220px;">100%</div><input type="range" style="margin-top: 50px" id="rs_slider" min="0" max="100" value="50"></input></div><div class="link-outer" style="margin-top: 30px"><div class="link-inner" id="in_continue">Next &#9654;</div></div></div>';
...
function crashType(QUNIT, to_append, answer_array)
{
	...
	var to_append = '<h1 style="font-size: 1.8em; margin-bottom: 30px">' + String(QUNIT['question']) + '</h1>';
	
	to_append += '<div style="display: inline-block; margin: 6px 8px; background: url(/images/crash_sprites.png) 0 0 no-repeat; height: 117px; width: 117px; cursor: pointer;" id="crash_rearend"></div>';
	to_append += '<div style="display: inline-block; margin: 6px 8px; background: url(/images/crash_sprites.png) 0 -117px no-repeat; height: 117px; width: 117px; cursor: pointer;" id="crash_leftturn"></div>';
	//to_append += '<div class="clear"></div>';
	to_append += '<div style="display: inline-block; margin: 6px 8px; background: url(/images/crash_sprites.png) 0 -234px no-repeat; height: 117px; width: 117px; cursor: pointer;" id="crash_drunk"></div>';
	to_append += '<div style="display: inline-block; margin: 6px 8px; background: url(/images/crash_sprites.png) 0 -351px no-repeat; height: 117px; width: 117px; cursor: pointer;" id="crash_none"></div>';
	to_append += '<div class="clear"></div>';
	...
	$("#test_interface").fadeOut(500, function(){
		$("#beta_box").css("width", "650px");
		$("#test_interface").html(to_append).css('margin-top', "35px").fadeIn(500);
		
		$("#crash_rearend").hover(function(){
			$("#crash_rearend").css("background-position", "-117px 2px");
		...
		$("#crash_drunk").hover(function(){
			$("#crash_drunk").css("background-position", "-117px -234px");
			$("#caption").html("Other Driver was Intoxicated");
		},function(){
			$("#crash_drunk").css("background-position", "0 -234px");
			$("#caption").html("&nbsp;");
		});
		$("#crash_leftturn").hover(function(){
			$("#crash_leftturn").css("background-position", "-117px -117px");
			$("#caption").html("Other Driver was making a left turn");
		},function(){
			$("#crash_leftturn").css("background-position", "0 -117px");
			$("#caption").html("&nbsp;");
		});
		$("#crash_none").hover(function(){
			$("#crash_none").css("background-position", "-118px -351px");
			$("#caption").html("Other");
		},function(){
			$("#crash_none").css("background-position", "0 -351px");
			$("#caption").html("&nbsp;");
		});
...
function taillight(QUNIT, to_append, answer_array)
{
	...
	$("#test_interface").fadeOut(500, function(){
		$("#beta_box").css("width", "650px");
		$("#test_interface").html(to_append).css('margin-top', "30px").fadeIn(500);
...
function recoveryTime(QUNIT, to_append, answer_array)
{
	...
	to_append += '</div>';
	to_append += '<div class="right" style="width: 300px; margin-right: 50px"><div style="position: relative;"><div style="position: absolute; top: 23px; left: 30px;">&le;1 month</div><div style="position: absolute; top: 23px; left: 204px;">6+ months</div><input type="range" style="margin-top: 50px;" id="red_cross_slider" min="0" max="3" value="0"></input></div><div class="link-outer" style="margin-top: 30px"><div class="link-inner" id="in_continue">Next &#9654;</div></div></div>';
...
function dollarAmounts(QUNIT, to_append, answer_array)
{
	...
	to_append += '<div style="height: 335px; width: 400px; -moz-border-radius: 8px; -webkit-border-radius: 8px; border-radius: 8px; margin: 0 auto; background: url(/images/yellow_pad.png); position: relative; box-shadow: 0 0 10px #CCC; border: 1px solid #DDD">';
	//Red line
	to_append += '<div style="position: absolute; height: 283px; width: 1px; top: 52px; left: 67px; background: rgba(255, 0, 72, 0.4)"></div>';
	to_append += '<div style="position: absolute; height: 283px; width: 1px; top: 52px; left: 65px; background: rgba(255, 0, 72, 0.4)"></div>';
	//Blue lines...
	...
	to_append += '<div class="link-outer" style="margin-top: 10px; position: relative; z-index: 100"><div class="link-inner" id="in_continue">Next &#9654;</div></div>';
	to_append += '</div>';
	...
	$("#test_interface").fadeOut(500, function(){
		$("#beta_box").css("width", "650px");
		$("#test_interface").empty().append(to_append).css('margin-top', "10px").fadeIn(500);
