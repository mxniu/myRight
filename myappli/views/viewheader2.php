...
<head>
	<meta charset="utf-8" />
	<title><?=$title?> | myRight</title>
	<meta name="description" content="<?=$description?>" />
	<meta property="og:title" content="<?=$title?> | myRight"/>
	<meta property="og:type" content="website"/>   
	<meta property="og:image" content="<?php if($poster) echo "http://myright.me/images/posters/".$poster->image; else echo "http://sphotos-b.xx.fbcdn.net/hphotos-ash4/487770_263685067078332_570461548_n.jpg";?>"/>   
	...
	<link rel="stylesheet" href="/css/viewport2.css" />
	<link rel="stylesheet" href="/css/viewalone2.css" />
	<link rel="stylesheet" href="/css/grid2.css" />
	<link rel="stylesheet" href="/css/layout3.css" /> 
	<link rel="stylesheet" href="/css/range.css" />
	<?php if($poster) {
		if($poster->gplus)
			echo '<link rel="author" href="'.$poster->gplus.'" />';
		else if($poster->url)
			echo '<link rel="author" href="'.$poster->url.'" />';
	}?>
	
	<link href='http://fonts.googleapis.com/css?family=Lato:700,400,300|Open+Sans:300, 400,600,700|Merriweather:400,700|PT+Sans:400|Old+Standard+TT:400|Karla:700' rel='stylesheet' type='text/css'>
	<script src="http://cdn.jquerytools.org/1.2.7/full/jquery.tools.min.js"></script>
	<script type='text/javascript' src='/js/bootstrap.js'></script>
	<script src="/js/testengine4.js"></script>
	<script src="/js/owenge.equation-beta.js"></script>
