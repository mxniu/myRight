...
<head>
	...
	<link href='http://fonts.googleapis.com/css?family=Lato:700,400|Arvo:400,700|Electrolize:400|Playfair+Display:400' rel='stylesheet' type='text/css'>
...
<section id="partition-1" style="text-align: center; position: relative">
	<div style="overflow: hidden;">
		...
		<div class="right" style="width: 470px; margin: 70px 100px 0 0">
			...
			<div style="overflow: hidden">
				<div class="orange-button left" id="nav1" style="margin: 25px 0 20px 0; width: 220px; height: 42px; padding: 6px 0 4px 0; font-family: 'Playfair Display', serif; font-size: 1.7em;">Personal</div>
				<div class="orange-button right" id="nav3" style="margin: 25px 0 20px 0; width: 220px; height: 42px; padding: 10px 0 0 0; font-family: 'Electrolize', sans-serif; font-size: 1.7em;">Startup Law</div>
			</div>
			<div class="orange-button" id="nav4" style="margin: 0 auto 15px; width: 220px; height: 42px; padding:10px 0 0 0; font-family: georgia, serif; font-style: italic; font-size: 1.7em;">In The News</div>
		</div>
	</div>
	...
	<section style="margin-top: 35px; overflow: hidden">
		...
		<div style="overflow: hidden">
			<div class="center topic_box" style="margin-left: 0; width: 638px; text-align: center;">
				...
				<a href="/child-custody/" class="white_variant">Child Custody</a>
				<a href="/security-deposit/" class="white_variant">Security Deposits</a>
				<a href="/employment/" class="white_variant">Employment</a>
				...
				<a href="/workplace-harassment/" class="white_variant">Workplace Harassment</a>
				<a href="/divorce-property/" class="white_variant">Divorce</a>
				<a href="/expungement/" class="white_variant">Expungement</a>
			</div>
		</div>
		<div class="section_break"></div>
		<div class="category_header" id="anchor3" style="font-family: 'Electrolize', sans-serif;">Legal Guides for Startups</div>
		<div style="overflow: hidden">
			<div class="center topic_box" style="margin-left: 0; width: 638px; text-align: center; height: 136px">
				...
				<a href="/independent-contractor-or-employee/" class="white_variant">Independent Contractor or Employee</a>
		...
		<div style="overflow: hidden">
			<div class="center topic_box" style="margin-left: 0; width: 638px; text-align: center;">
				<a href="/marijuana/" class="white_variant">Marijuana</a>
	...
	<section style="background: rgba(255, 255, 255, 0.9); text-align: left; margin: 85px 0 0 0; position: relative; width: 920px; padding: 30px 20px 80px; box-shadow: 0px 0px 2px 1px #AAA;">
		<div class="logo_med"></div>
		<div style="text-align: left; font-family: 'Lato', sans-serif; font-weight: 600; font-size: 20px; margin: 80px auto 0; padding-left: 5px; color: #51c7f4; padding-bottom: 5px">Mission</div>
