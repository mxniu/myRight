...
<head>
	...
	<link href='http://fonts.googleapis.com/css?family=Quattrocento:400,700|Lato:700,400,300|Open+Sans:300, 400,600,700|Merriweather:300,400,700|PT+Sans:400|PT+Serif:400|Old+Standard+TT:700,400|Karla:700|Josefin+Slab:600' rel='stylesheet' type='text/css'>
	...
	<ul id="main_nav">
		<li class="dropdown">
			...
			<ul class="dropdown-menu" id="about_drop">
				<li><a data-toggle="modal" href="#disclaimerModal" data-backdrop="static" class="about_disclaimer">Disclaimer</a></li>
				<li><a data-toggle="modal" href="#disclaimerModal" data-backdrop="static" class="about_privacy">Privacy</a></li>
				<li><a data-toggle="modal" href="#disclaimerModal" data-backdrop="static" class="about_terms">Terms of Use</a></li>
				<li><a href="mailto:info@myright.me">Contact</a></li>	
				<li><a href="http://myright.me/blog" target="_blank">Blog</a></li>
			</ul>
		</li>
		<li><a href="#" class="unlinked">+ Add Post</a></li>
	</ul>
