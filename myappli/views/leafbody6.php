...
<section id="partition-2">
	<div id="list-elements"  style="margin-top: 20px; border-radius: 10px 10px 0 0">
		<div style="font-family: Arvo; text-align: left; color: #666; font-size: 20px; margin: 20px 20px 0; border-bottom: 1px dotted #666; width: 300px; padding-bottom: 5px;"><?=$category->name?> Basics in <?=$state_name?></div>
